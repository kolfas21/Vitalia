...
import {InicioAdminComponent } from './dashboards/dashboard-admin/inicio/inicio.component';
...
export const routes: Routes = [
  ...
  { path: 'dashboards/dashboard-admin/inicio', component: InicioAdminComponent },
  // otras rutas...
  { path: '**', redirectTo: '' }
];